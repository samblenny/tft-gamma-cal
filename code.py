...
class GammaCurve:
    ...
    PRESETS = {
        ...
        "Feather2.2": (  0,  255,  196, 148, 104,   64,   36,   16,     8),
        "Feather1.8": (  0,  255,  228, 204, 176,  136,   92,   52,    26),
        "Feather2.5": (  0,  255,  212, 192, 160,  124,   76,   38,    12),
        "Feather1.0": (  0,  255,  250, 236, 208,  176,  128,   80,    40),
